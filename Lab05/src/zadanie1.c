...
int main() {
  ...
  switch(operacja){
    case 1:{
        printf("suma liczb %d i %d wynosi: %d\n",liczba1, liczba2, suma(liczba1,liczba2));
        break;
    }
    case 2:{
        printf("roznica liczb %d i %d wynosi: %d\n",liczba1, liczba2, roznica(liczba1,liczba2));
        break;
    }
    case 3:{
        printf("iloczyn liczb %d i %d wynosi: %d\n",liczba1, liczba2, iloczyn(liczba1,liczba2));
        break;
    }
    case 4:{
        printf("iloraz liczb %d i %d wynosi: %d\n",liczba1, liczba2, iloraz(liczba1,liczba2));
        break;
    }
    default:{
